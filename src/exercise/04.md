...
- Use `React.useLayoutEffect()` if you need to manipulate a DOM element after it
  was instantiated but before it is mounted into the DOM.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=04%3A%20useLayoutEffect%3A%20auto-scrolling%20textarea&em=epicreact%40martynus.net).
